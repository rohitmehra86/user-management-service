...
@ComponentScan(basePackages = { "com.paxaris.usermanagement.tenant.repository", "com.paxaris.usermanagement.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.paxaris.usermanagement.tenant.repository", "com.paxaris.usermanagement.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.paxaris.usermanagement");
